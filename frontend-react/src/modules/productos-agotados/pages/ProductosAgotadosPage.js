      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        >
          <div>
            ...
            <p style={{ margin: '5px 0 0 0', color: '#666' }}>
              ...
              completamente, incluyendo métricas de rendimiento y tendencias de
              venta.
            </p>
          </div>
          <button
        ...
        {error ? (
          ...
          >
            ...
            >
              Los productos que se agoten aparecerán automáticamente en esta
              tabla
            </p>
          </div>
        ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '15px', textAlign: 'center' }}>
                          {productoAgotado.tiempo_vida
                            ? `${productoAgotado.tiempo_vida} días`
                            : 'N/A'}
                        </td>
                        <td style={{ padding: '15px', textAlign: 'center' }}>
                          <span
