...
from .views import (
    ...
    ChangePasswordView,
    LogoutView,
    ProductoAgotadoViewSet,
    ProductoAgotadoReportePDFView,
    VentasDelDiaView,
    UserViewSet,
    # Dashboard views
    DashboardTotalInventoryView,
    DashboardLowStockView,
    DashboardDailySalesView,
...
urlpatterns = [
    ...
    # Dashboard endpoints
    path(
        "reports/dashboard/total-inventory/",
        DashboardTotalInventoryView.as_view(),
        name="dashboard-total-inventory",
    ),
    path(
    ...
    path(
        "reports/dashboard/daily-sales/",
        DashboardDailySalesView.as_view(),
        name="dashboard-daily-sales",
    ),
    path(
        "reports/dashboard/sales-trend/",
    ...
    path(
        ...
        DashboardRecentSalesView.as_view(),
        name="dashboard-recent-sales",
    ),
    path(
        "productos-agotados/generar-reporte-pdf/",
        ProductoAgotadoReportePDFView.as_view(),
        name="productos-agotados-pdf",
    ),
